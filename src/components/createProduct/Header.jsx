...
export default function Header({ languageProps, languageChangeButtonProps }) {
  const contentLanguage = {
    ...
    description: {
      ...
      id: "Di bawah ini adalah contoh formulir yang dibuat seluruhnya dengan kontrol formulir Bootstrap. Setiap grup formulir yang diperlukan memiliki status validasi yang dapat dipicu dengan mencoba mengirimkan formulir tanpa melengkapinya.",
    },
  };
  return (
    <header className="container mx-auto px-5 py-6 text-center">
      <img src={bootstrapImages} width={150} height={"auto"} alt="Tailwind" className="mx-auto mb-5 mt-1" />
